...
namespace Uno.UI.SourceGenerators.Telemetry
{
	public class Telemetry
	{
		...
		public Telemetry(string instrumentationKey) : this(instrumentationKey, null) { }

		public Telemetry(string instrumentationKey, Func<bool?>? enabledProvider) : this(instrumentationKey, null, enabledProvider: enabledProvider) { }
